--[[
	...
	TAP'S DECOMPILER is a revival of Moon's Dex, made to fulfill Moon's Dex prophecy.
]]
...
Main = (function()
	...
	Main.Apps = Apps
	Main.MenuApps = {}
	Main.GitRepoName = "jaydenmcl/Dex-"
	...
	Main.Error = function(str)
		if rconsoleprint then
			rconsoleprint("CALLBACK ERROR: "..tostring(str).."\n")
			wait(9e9)
		else
			error(str)
		end
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="TAP'S DECOMPILER",TextColor3=Color3.new(1,1,1),TextSize=50,TextTransparency=1,}},
	...
	Main.SetMainGuiOpen = function(val)
		...
		Main.MainGui.OpenButton.Text = val and "Close" or "TAP'S DECOMPILER"
	...
	Main.SetupFilesystem = function()
		...
		makefolder("TAP")
		makefolder("TAP/assets")
		makefolder("TAP/saved")
		makefolder("TAP/plugins")
		makefolder("TAP/ModuleCache")
	end
